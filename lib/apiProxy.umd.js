(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["apiProxy"] = factory(require("Vue"), require("axios"));
	else
		root["apiProxy"] = factory(root["Vue"], root["axios"]);
...
var param_handler_assignParams = function assignParams(obj, params) {
  if (params) {
    ...
    if (obj.isFormData && [http_method.POST, http_method.PUT, http_method.DELETE].includes(obj.method)) {
      obj.data = lib_default.a.stringify(copyParams);
    } else if (http_method.GET === obj.method) {
      obj.url = "".concat(obj.url, "?").concat(lib_default.a.stringify(copyParams));
...
/* harmony default export */ var src = (function (apiObj, config) {
  ...
  var newObj = Object.assign({}, apiObj);
  ...
  var request = function request(obj, params) {
    obj.url = obj.url + (config.pathSuffix || ''); // @ts-ignore
...
//# sourceMappingURL=apiProxy.umd.js.map